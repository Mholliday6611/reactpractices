...
// console.log(addToPlaylist(episodes, finaleEpisode))
...
// console.log(removeFromPlaylist(episodes, episodes[0]))
...
const getNextEpisodeInPlaylist = (nextEpisodes)=>nextEpisodes[0];

var  bingeWatch = function(list){
  if (list.length == 0) {
    console.log("done")
  }
  else{
    // console.log(list)
    var nextEpisode = getNextEpisodeInPlaylist(list);

    console.log(nextEpisode)
    console.log(list.length)
    var newList = removeFromPlaylist(list, nextEpisode)
